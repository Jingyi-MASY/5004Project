...
public interface IShape {
   ...
   * @throws IllegalArgumentException if the passed in time if outr of this shape's appearance time.
   */
   ...
   * @return  a list of Color elements that indicates the color status of this shape at every
   *          time unit of its appearance time.
   */
   ...
   * @return  a list of Position2D elements that indicates the position of this shape at every
   *          time unit of its appearance time.
   */
   ...
   * @param time  time that is looking for, int type.
   * @return  a new shape object that is created based on the status of all aspect of this shape
   *          at passed in time, IShape type.
