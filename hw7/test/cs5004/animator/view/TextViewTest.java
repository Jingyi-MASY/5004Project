...
public class TextViewTest {
  ...
  public void testShowAll() {
    ...
    assertEquals("Create java.awt.Color[r=0,g=128,b=128] rectangle r1 with corner at "
            + "(0, 0), width 100 and height 200\n"
            + "Create java.awt.Color[r=128,g=100,b=100] rectangle r2 with corner at "
            + "(100, 200), width 200 and height 50\n"
            + "Create java.awt.Color[r=0,g=0,b=255] ellipse e1 with center at "
            + "(150, 300), radius 50 and 100\n"
            + "Create java.awt.Color[r=128,g=128,b=56] rectangle r3 with corner at "
            + "(1, 300), width 60 and height 80\n"
            + "Create java.awt.Color[r=60,g=80,b=120] ellipse e2 with center at "
            + "(450, 487), radius 50 and 37\n"
            + "Create java.awt.Color[r=60,g=80,b=120] rectangle r4 with corner at "
            ...
            + "\n"
            + "e1 changes from java.awt.Color[r=0,g=0,b=255] to java.awt.Color[r=255,g=0,b=255] "
            ...
            + "r1 changes from java.awt.Color[r=0,g=128,b=128] to java.awt.Color"
            ...
            + "r3 changes from java.awt.Color[r=128,g=128,b=56] to java.awt.Color"
            ...
            + "e2 changes from java.awt.Color[r=60,g=80,b=120] to java.awt.Color"
            ...
            + "r4 changes from java.awt.Color[r=60,g=80,b=120] to java.awt.Color"
            + "[r=100,g=200,b=186] from time t=20 to t=120\n"
            ...
            + "r2 changes from java.awt.Color[r=128,g=100,b=100] to java.awt.Color"
  ...
  public void testShowOneShape1() {
    ...
    assertEquals("Create java.awt.Color[r=0,g=128,b=128] rectangle r1 with corner "
            + "at (0, 0), width 100 and height 200\n"
            + "r1 appears at time t=1 and disappears at time t=100\n"
            + "r1 changes from java.awt.Color[r=0,g=128,b=128] to java.awt.Color[r=200,g=150,"
            + "b=100] from time t=1 to t=100\n"
            + "r1 moves from (0, 0) to (200, 200) from time t=1 to t=100\n"
            + "r1 changes width from 100 to 50 from time t=1 to t=100\n"
            + "r1 changes height from 200 to 100 from time t=1 to t=100\n"
            + "Create java.awt.Color[r=128,g=100,b=100] rectangle r2 with corner at (100, 200), "
            + "width 200 and height 50\n"
            + "Create java.awt.Color[r=0,g=0,b=255] ellipse e1 with center at (150, 300), "
            + "radius 50 and 100\n"
            + "Create java.awt.Color[r=128,g=128,b=56] rectangle r3 with corner at (1, 300), "
            + "width 60 and height 80\n"
            + "Create java.awt.Color[r=60,g=80,b=120] ellipse e2 with center at (450, 487), "
            + "radius 50 and 37\n"
            + "Create java.awt.Color[r=60,g=80,b=120] rectangle r4 with corner at (300, 450), "
  ...
  public void testShowOneShape2() {
    ...
    assertEquals("Create java.awt.Color[r=0,g=128,b=128] rectangle r1 with corner "
            ...
            + "Create java.awt.Color[r=128,g=100,b=100] rectangle r2 with corner at (100, 200), "
            + "width 200 and height 50\n"
            + "Create java.awt.Color[r=0,g=0,b=255] ellipse e1 with center at (150, 300), radius "
            + "50 and 100\n"
            + "Create java.awt.Color[r=128,g=128,b=56] rectangle r3 with corner at (1, 300), "
            + "width 60 and height 80\n"
            + "Create java.awt.Color[r=60,g=80,b=120] ellipse e2 with center at (450, 487), "
            ...
            + "width 100 and height 75\n"
            + "r4 appears at time t=20 and disappears at time t=120\n"
            + "r4 changes from java.awt.Color[r=60,g=80,b=120] to java.awt.Color[r=100,g=200,"
  ...
  public void testShowOneShape3() {
    ...
    assertEquals("Create java.awt.Color[r=0,g=128,b=128] rectangle r1 with "
